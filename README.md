...
Working on a programmable agent execution environment with its own language and compiler that turns agent logic into structured workflows. The idea is to make multi-agent behavior reliable and inspectable instead of just hoping a prompt works.
